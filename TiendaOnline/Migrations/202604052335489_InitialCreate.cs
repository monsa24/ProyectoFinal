namespace TiendaOnline.Migrations
{
    ...
    public partial class InitialCreate : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        Resenia = c.String(nullable: false, maxLength: 80),
                    })
                .PrimaryKey(t => t.Id);
            ...
            CreateTable(
                ...
                c => new
                    {
                        Id = c.String(nullable: false, maxLength: 128),
                        FullName = c.String(maxLength: 80),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.CompraModels", "ProductoId", "dbo.ProductoModels");
            ...
            DropIndex("dbo.CompraModels", new[] { "ProductoId" });
